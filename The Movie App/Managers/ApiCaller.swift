...
struct Constants {
    static let API_KEY = "4f0d3bb5fa69fc4aab6f6555a53f2775"
    static let baseURL = "https://api.themoviedb.org"
    static let youtubeAPI_Key = "AIzaSyDyh-XM5wCwmH0asSZG9T5NSfMVtC7Ik6o"
...
class ApiCaller {
    ...
    func getTrendingMovies(completion: @escaping (Result<[Title], Error>) -> Void) {
        ...
        let task = URLSession.shared.dataTask(with: URLRequest(url: url)) { data, _, error in
            ...
            do {
                let results = try JSONDecoder().decode(AllTitles.self, from: data)
    ...
    func getDiscoverMovies(with page: Int,completion: @escaping (Result<[Title], Error>) -> Void) {
    ...
    func getReview(id: Int, media: String, completion: @escaping (Result<[Author], Error>) -> Void) {
